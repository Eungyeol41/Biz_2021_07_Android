...
import com.ini.library.databinding.ActivityMainBinding;
import com.ini.library.databinding.BookItemViewBinding;
...
public class BookAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        TextView txt_title = bookHolder.bookItemView.itemTextTitle;
        /*
         * HtmlCompat.fromHtml()
         *
         * 문자열 내에 HTML tag가 포함되어 있으면 tag의 효과를 적용하여 문자열을 화면에 그리기 위한 변환 method()
         *
         * Nougat(7.0) 이상에서만 작동되는 method()
         * Nougat 이하에서는 원래는 작동되었지만, 최근 Android에서는 제거되었다.
         */
    ...
    public static class BookViewHolder extends RecyclerView.ViewHolder{
        ...
        /*
         * DataBinding이 true로 되어있을 때 book_item)view.xml layout 파일을 생성하면 자동으로 선언되는 클래스
         *
         * DataBinding을 선언하면 layout.xml에 선언된 Component를 일일히 한 개씩 세팅하지 않아도 binding 객체 한 개만 세팅하면 나머지는 자동으로 같이 세팅된다.
         */
