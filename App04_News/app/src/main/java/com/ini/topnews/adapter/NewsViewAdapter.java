package com.ini.topnews.adapter;
...
import com.ini.topnews.databinding.NewsItemViewBinding;
...
public class NewsViewAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull RecyclerView.ViewHolder holder, int position) {
        ...
        /*
         * 매개변수로 받은 holder는 RecyclerView.ViewHolder type으로 실제 사용해야하는 NewsViewHolder의 부모 클래스 type이다.
         * 때문에 실제 사용하기 위해서는 NewsViewHolder type으로 Cast 해야 한다.
         */
...
//      viewHolder.viewBinding.newsItemTitle.setText(newsDTO.getTitle()); // 아래랑 같은 것
