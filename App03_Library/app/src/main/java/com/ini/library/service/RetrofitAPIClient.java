...
/*
 * Retrofit을 사용하여 다른 network(server)에 접속하기 위한 기본 설정 객체를 만들어서 배포하는 Class
 */
public class RetrofitAPIClient {
     ...
     *
     * getConnection() method를 호출하여 Connection instance를 가져오고
     *      instance의 create() method를 사용하여 RetrofitAPIClient interface를 구현한 코드를 생성한다
     *
     * @return
     */
